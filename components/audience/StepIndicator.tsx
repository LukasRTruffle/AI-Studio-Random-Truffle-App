...
const StepIndicator: React.FC = () => {
    ...
    const steps = [ "Describe", "Strategy", "SQL Check", "Preview", "Metadata", "Consent", "Create", "Activation", "Dry Run", "Monitor" ];
                        ...
                        {currentStep > index + 1 ? (
                            ...
                            <>
                                ...
                                <div className="relative flex h-8 w-8 items-center justify-center rounded-full border-2 border-blue-600 bg-white">
                                 ...
                                 <span className="absolute -bottom-6 text-sm font-medium text-blue-600">{stepName}</span>
                            </>
                        ) : (
                            <>
                                <div className="absolute inset-0 flex items-center" aria-hidden="true">
