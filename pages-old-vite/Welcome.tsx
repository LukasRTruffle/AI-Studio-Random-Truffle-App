  ...
  return (
    <div className="p-6 md:p-10">
      <PageHeader
        ...
        subtitle="This is your Builder dashboard."
      />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <p className="mt-2 text-gray-600">
            Builder is an AI-powered platform to help you create, manage, and activate customer
            audiences with unparalleled speed and precision.
          </p>
        </Card>
      </div>
    </div>
