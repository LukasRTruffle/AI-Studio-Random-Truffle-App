...
export const CreateAudienceContext = createContext<CreateAudienceContextType | undefined>(
  undefined
);
...
export const CreateAudienceProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <CreateAudienceContext.Provider
      value={{ currentStep, audienceState, setAudienceState, nextStep, prevStep }}
    >
      {children}
    </CreateAudienceContext.Provider>
  );
